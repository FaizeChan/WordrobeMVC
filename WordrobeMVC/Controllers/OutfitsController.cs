...
using WordrobeMVC.Models;

namespace WordrobeMVC.Controllers
{
    public class OutfitsController : Controller
    {
        private ClothingDBEntities db = new ClothingDBEntities();
        ...
        public ActionResult Create([Bind(Include = "OutfitsID,TopsID,BottomsID,ShoesID,AccessoriesID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitsID,TopsID,BottomsID,ShoesID,AccessoriesID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
