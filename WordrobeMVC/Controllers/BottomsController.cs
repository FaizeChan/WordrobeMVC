...
namespace WordrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Name,Photo,Type,Color,Season,Occasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Name,Photo,Type,Color,Season,Occasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
